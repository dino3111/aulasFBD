...
```
As entidades da base de dados são: Fornecedor, Encomenda, Produto e Tipo.

Fornecedor tem estes atributos: Endereço, NIF, FAX, Condições de Pagamento e Nome.

Encomenda tem estes atributos: num_Encomenda e Data.

Produto tem estes atributos: IVA, Nome, Código, num_Unidades e Preço.

Tipo tem estes atributos: Código e Designação.

Existem três relações: "Encomenda Contém Produto", "Encomenda é Fornecida por Fornecedor" e "Fornecedor é Tipo Fornecedor de Tipo".
```
...
```
A relação "Encomenda Contém Produto" é de grau binário com cardinalidade muitos para muitos e obrigatoriedade total.

A relação "Encomenda é Fornecida por Fornecedor" é de grau binário com cardinalidade um para muitos e obrigatoriedade total.

A relação "Fornecedor é Tipo Fornecedor de Tipo" é de grau binário com cardinalidade um para muitos e obrigatoriedade total.
